...
class ResidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resident" do
    assert_difference('Resident.count') do
      post residents_url, params: { resident: { address: @resident.address, city: @resident.city, lot_number: @resident.lot_number, resident_one: @resident.resident_one, resident_two: @resident.resident_two, state: @resident.state, zip_code: @resident.zip_code } }
    end
  ...
  test "should update resident" do
    patch resident_url(@resident), params: { resident: { address: @resident.address, city: @resident.city, lot_number: @resident.lot_number, resident_one: @resident.resident_one, resident_two: @resident.resident_two, state: @resident.state, zip_code: @resident.zip_code } }
